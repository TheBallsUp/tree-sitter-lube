...
enum {
  ...
  sym_dedent = 6,
  sym_file_tree = 7,
  sym__node_definition = 8,
  sym_file_node_definition = 9,
  sym_directory_node_definition = 10,
  sym_title = 11,
  sym__nested = 12,
  aux_sym_file_tree_repeat1 = 13,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [4] = {
    [sym_file_node_definition] = STATE(15),
    [sym_directory_node_definition] = STATE(15),
    [sym_title] = STATE(13),
    [sym__nested] = STATE(16),
    [sym_hidden_node_definition] = ACTIONS(5),
    [aux_sym_file_node_definition_token1] = ACTIONS(7),
    [anon_sym_SLASH] = ACTIONS(9),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directory_node_definition, 1),
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directory_node_definition, 2),
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directory_node_definition, 3),
  ...
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__nested, 1, .production_id = 1),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directory_node_definition, 2, .production_id = 2),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directory_node_definition, 3, .production_id = 3),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directory_node_definition, 4, .production_id = 4),
};
